...
public class BicicletaElectrica extends Bicicleta {
    ...
    public String toString() {
        return "BicicletaElectrica{" + "marcaBateria=" + marcaBateria + ", potenciamotor=" + potenciamotor + ", marcaMotor=" + marcaMotor + ", kilometrosPromedio=" + kilometrosPromedio + ", tipoControl=" + tipoControl + ", tipoConectividad=" + tipoConectividad + ", tipoCarga=" + tipoCarga + '}';
    }
